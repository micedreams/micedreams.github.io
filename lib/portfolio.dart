            ...
            children: [
              const Column(
                ...
                children: [
                  ...
                  ProjectWidget(
                    name: "Sleepy time clone: ",
                    link: 'https://micedreams.github.io/sleepy_time/#/',
                    gitHubLink: 'https://github.com/micedreams/sleepy_time',
                  ),
                  ProjectWidget(
                    name: "Magic ball: ",
                    link: 'https://micedreams.github.io/magic_ball/#/',
                    gitHubLink: 'https://github.com/micedreams/magic_ball',
                  ),
                  ProjectWidget(
                    name: "Tic Tac Toe: ",
                    link: '',
                    gitHubLink: 'https://github.com/micedreams/tic-tac-toe',
                  ),
                  ProjectWidget(
                    name: "Minesweeper: ",
                    link: '',
                    gitHubLink: 'https://github.com/micedreams/minesweeper',
                  ),
                  ProjectWidget(
                    name: "Game of Life: ",
                    link: '',
                    gitHubLink: 'https://github.com/micedreams/game_of_life',
                  ),
                ],
              ),
              Row(
                ...
                children: [
                  const Button(
                    link: 'https://github.com/micedreams',
                    name: 'Github',
                    icon: githubSvg,
                  ),
                  const Button(
                    link: 'https://micedreams.github.io/CV/',
                    name: 'CV',
                    icon: cvSvg,
                  ),
                  Button(
                    link:
                        "mailto:${Uri.encodeComponent("micedreams@gmail.com")}?subject= Hi &body= Hi,",
                    name: 'Say hi!!',
                    icon: mailSvg,
                  ),
                ],
